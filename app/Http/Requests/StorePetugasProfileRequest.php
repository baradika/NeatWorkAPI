...
class StorePetugasProfileRequest extends FormRequest
{
    ...
    {
        return [
            'ktp_number' => 'required|string|size:16|unique:petugas_profiles,ktp_number',
            'ktp_photo' => 'required|image|mimes:jpeg,png,jpg|max:2048',
            'selfie_with_ktp' => 'required|image|mimes:jpeg,png,jpg|max:2048',
    ...
    public function messages(): array
    {
        return [
            ...
            'selfie_with_ktp.max' => 'Ukuran file maksimal 2MB',
