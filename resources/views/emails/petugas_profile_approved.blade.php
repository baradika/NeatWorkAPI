...
<head>
  ...
  <title>Persetujuan Verifikasi Petugas</title>
  <style>
...
<body>
  <div class="card">
    ...
    <div class="content">
      <p>Halo {{ $fullName }},</p>
      <p>Selamat! Pengajuan verifikasi Anda sebagai Petugas telah <strong>disetujui</strong> pada {{ $date }}.</p>
      <p>Anda kini dapat mengakses Dashboard Petugas dan mulai menerima pekerjaan.</p>
      <p>
        <a class="btn" href="{{ config('app.url') }}/dashboard/petugas" target="_blank" rel="noopener">Buka Dashboard</a>
      </p>
      <p class="muted">Jika tombol di atas tidak berfungsi, salin dan tempel URL berikut ke peramban Anda:<br>
        {{ config('app.url') }}/dashboard/petugas
      </p>
      <p>Terima kasih telah bergabung bersama NeatWork.</p>
      <p>Salam hangat,<br>Tim NeatWork</p>
    </div>
    <div class="footer">
